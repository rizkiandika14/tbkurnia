...
?>
<br>
<a href="laporan.php" class="btn btn-light btn-xs px-3 py-2 mb-2" style="font-weight:500;"><i
        class="fa fa-chevron-left fa-xs"></i> Kembali</a>
<div class="row">
    <div class="col-sm-6">
...
<table class="table table-sm table-bordered dt-responsive nowrap border-0" id="cart" width="100%">
    ...
    <tr>
        ...
        <th class="border-0 bg-white"></th>
        <th class="text-right bg-light" style="border: 1px solid #dee2e6;font-weight:600;">Diskon :</th>
        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">
            Rp.<?php echo ribuan($checkdb['diskon']) ?></th>
    </tr>
    <tr>
        <th class="d-none d-sm-block d-md-block border-0 bg-white"></th>
        <th class="border-0 bg-white"></th>
        ...
        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">
            Rp.<?php echo ribuan($checkdb['totalbeli']) ?></th>
    </tr>
    <tr>
        <th class="d-none d-sm-block d-md-block border-0 bg-white"></th>
        <th class="border-0 bg-white"></th>
        ...
        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">
            Rp.<?php echo ribuan($checkdb['pembayaran']) ?></th>
    </tr>
    <tr>
        <th class="d-none d-sm-block d-md-block border-0 bg-white"></th>
        <th class="border-0 bg-white"></th>
        ...
        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">
            Rp.<?php echo ribuan($checkdb['kembalian']) ?></th>
    </tr>
</table>
