...
<div class="row mt-3">
    ...
    <div class="col-lg-3 mb-3">
        <input type="hidden" class="form-control form-control-sm bg-white" id="date-time" readonly>
            ...
            <div class="card-body p-2">
                <div style="display:none;width: 100%;" id="Tambah1">
                 ...
                 values ('$nama_pelanggan','$telepon_pelanggan','$alamat_pelanggan')");
                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col-5 mb-2 text-right pt-1 pr-1 text-primary">Pelanggan : </div>
                            <div class="col-7 mb-2 pl-0">
                                <input type="text" class="form-control form-control-sm" name="nama_pelanggan" required>
                            </div>
                            <div class="col-5 mb-2 text-right pt-1 pr-1 text-primary">No.Member : </div>
                            <div class="col-7 mb-2 pl-0">
                                <input type="number" class="form-control form-control-sm" name="telepon_pelanggan">
                            </div>
                            <div class="col-5 text-right pt-1 pr-1 text-primary">Alamat : </div>
                ...
                <div id="Ada1">
                    <div class="row">
                        <div class="col-5 mb-2 text-right pt-1 pr-1">Pelanggan Member : </div>
                        <div class="col-7 mb-2 pl-0">
                            <?php
                        ...
                        <div class="col-5 mb-2 text-right pt-1 pr-1">No.Member : </div>
                        <div class="col-7 mb-2 pl-0">
                            <input type="text" class="form-control form-control-sm bg-white" id="telepon_pelanggan"
                                readonly>
                        </div>
                        <div class="col-5 text-right pt-1 pr-1">Alamat : </div>
                        <div class="col-7 pl-0">
                            <input type="text" class="form-control form-control-sm bg-white" id="alamat_pelanggan"
                                readonly>
                        </div>
                    </div>
                </div><!-- end ada1 -->
        ...
        <div class="card small mb-3">
            <div class="card-header p-2">
                <div class="card-tittle"><i class="far fa-user mr-1"></i>Pelanggan
                    <a class="float-right" href="#" onclick="TambahBaru2()">
                        Tambah Baru ?
                    </a>
                </div>
            </div>
            <div class="card-body p-2">
                <div style="display:none;width: 100%;" id="Tambah2">
                    <?php
                    if (isset($_POST['alamat_pelanggan2'])) {
                        $nama_pelanggan    = htmlspecialchars($_POST['nama_pelanggan2']);
                        // $telepon_pelanggan = htmlspecialchars($_POST['telepon_pelanggan']);
                        $alamat_pelanggan  = htmlspecialchars($_POST['alamat_pelanggan2']);
                        $tambahPel         = mysqli_query($conn, "INSERT INTO pelanggan(nama_pelanggan,telepon_pelanggan,alamat_pelanggan)
                 values ('$nama_pelanggan','-','$alamat_pelanggan')");
                        if ($tambahPel) {
                            echo '<script>alert("Tambah Data Pelanggan Berhasil");window.location="index.php"</script>';
                        } else {
                            echo '<script>alert("Maaf! data yang anda masukan salah.");history.go(-1);</script>';
                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col-5 mb-2 text-right pt-1 pr-1 text-primary">Pelanggan : </div>
                            <div class="col-7 mb-2 pl-0">
                                <input type="text" class="form-control form-control-sm" name="nama_pelanggan2" required>
                            </div>
                            <!-- <div class="col-5 mb-2 text-right pt-1 pr-1 text-primary">No.Member : </div>
                            <div class="col-7 mb-2 pl-0">
                                <input type="text" class="form-control form-control-sm" name="telepon_pelanggan2"
                                    required>
                            </div> -->
                            <div class="col-5 text-right pt-1 pr-1 text-primary">Alamat : </div>
                            <div class="col-7 pl-0">
                                <input type="text" class="form-control form-control-sm" name="alamat_pelanggan2"
                                    onchange="form.submit()" required>
                            </div>
                        </div>
                    </form>
                ...
                <div id="Ada2">
                    <div class="row">
                        <div class="col-5 mb-2 text-right pt-1 pr-1">Pelanggan : </div>
                        <div class="col-7 mb-2 pl-0">
                            <?php
                            $plgnn      = mysqli_query($conn, "SELECT * FROM pelanggan where telepon_pelanggan ='-' order by idpelanggan ASC");

                            $jsArraypp1 = "var alamat_pelanggann = new Array();";
                            $jsArraypp2 = "var idpelanggann = new Array();";
                            ?>
                            <input type="text" class="form-control form-control-sm bg-white" list="datalist3"
                                onchange="changeValuePelanggan2(this.value)" required>
                            <datalist id="datalist3">
                                <?php
                                if (mysqli_num_rows($plgnn)) {
                                    while ($row_p = mysqli_fetch_array($plgnn)) { ?>
                                <option value="<?php echo $row_p["nama_pelanggan"] ?>">
                                    <?php echo $row_p["nama_pelanggan"] ?>
                                    <?php
                                        // $jsArrayp  .= "telepon_pelanggan['" . $row_p['nama_pelanggan'] . "'] = {telepon_pelanggan:'" . addslashes($row_p['telepon_pelanggan']) . "'};";
                                        $jsArraypp1 .= "alamat_pelanggann['" . $row_p['nama_pelanggan'] . "'] = {alamat_pelanggann:'" . addslashes($row_p['alamat_pelanggan']) . "'};";
                                        $jsArraypp2 .= "idpelanggann['" . $row_p['nama_pelanggan'] . "'] = {idpelanggann:'" . addslashes($row_p['idpelanggan']) . "'};";
                                    } ?>
                                    <?php } ?>
                            </datalist>
                        </div>
                        <!-- <div class="col-5 mb-2 text-right pt-1 pr-1">No.Member : </div>
                        <div class="col-7 mb-2 pl-0">
                            <input type="text" class="form-control form-control-sm bg-white" id="telepon_pelanggan2"
                                readonly>
                        </div> -->
                        <div class="col-5 text-right pt-1 pr-1">Alamat : </div>
                        <div class="col-7 pl-0">
                            <input type="text" class="form-control form-control-sm bg-white" id="alamat_pelanggan2"
                                readonly>
                        </div>
                    </div>
                </div><!-- end ada1 -->
    ...
    <div class="col-lg-9" id="print">
        <form id="myCartNew" method="post">
            <div class="row print-none">
                <div class="col-12 col-lg-3 m-pr-0">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm border-right-0" list="datalist1"
                            onchange="changeValue(this.value)" aria-describedby="basic-addon2" id="kode_produk"
                            required>
                ...
                <div class="col-6 col-lg-2 pr-0">
                    <?php
                    $barang   = mysqli_query($conn, "SELECT * FROM produk ORDER BY idproduk ASC");
                    $jsArrayy  = "var harga_jual = new Array();";
                    $jsArrayy1 = "var kode_produk = new Array();";
                    $jsArrayy3 = "var idproduk = new Array();";
                    $jsArrayy4 = "var stock = new Array();";
                    ?>
                    <label class="mb-1">Nama Produk</label>
                    <div class="input-group">
                        <input type="hidden" class="form-control form-control-sm bg-white" name="idproduk" id="idproduk"
                            readonly>
                        <input type="text" class="form-control form-control-sm bg-white" id="nama_produk"
                            list="datalist" onchange="changeValue1(this.value)" aria-describedby="basic-addon2"
                            required>
                        <datalist id="datalist">
                            <?php
                            if (mysqli_num_rows($barang)) {
                                while ($row_brg = mysqli_fetch_array($barang)) { ?>
                            <option value="<?php echo $row_brg["nama_produk"] ?>"> <?php echo $row_brg["nama_produk"] ?>
                                <?php $jsArray .= "harga_jual['" . $row_brg['nama_produk'] . "'] = {harga_jual:'" . addslashes($row_brg['harga_jual']) . "'};";
                                    $jsArray1 .= "kode_produk['" . $row_brg['nama_produk'] . "'] = {kode_produk:'" . addslashes($row_brg['kode_produk']) . "'};";
                                    $jsArray3 .= "idproduk['" . $row_brg['nama_produk'] . "'] = {idproduk:'" . addslashes($row_brg['idproduk']) . "'};";
                                    $jsArray4 .= "stock['" . $row_brg['nama_produk'] . "'] = {stock:'" . addslashes($row_brg['stock']) . "'};";
                                } ?>
                                <?php } ?>
                        </datalist>
                    </div>
                ...
                <div class="col-6 col-lg-2 m-pr-0">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-info btn-sm border-0" onchange="total()">
                                </i> Add</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm bg-white" id="subtotal" name="tambahcuy"
        ...
        if (isset($_POST['tambahcuy'])) {
            ...
            if ($stock < $quantity) {
                ...
                if ($insert) {
                    $insertstock = mysqli_query($conn, "INSERT INTO stock (idproduk,jumlah_stock,status_stock) VALUES ('$idproduk','$quantity','2')");
        ...
        <div class="d-none pt-5 px-4 print-show">
            <div class="row">
                ...
                $subtotalcart2 = 0;
                $no = 1;
                $data_produk1 = mysqli_query($conn, "SELECT * FROM keranjang c, produk p WHERE p.idproduk=c.idproduk ORDER BY idcart ASC");
                ...
                <div class="col-12 mb-2">
                    <div class="row">
                        <div class="col-1 text-center">
                            <h3><?php echo $c['quantity'] ?></h3>
                        </div>
                        <div class="col">
                            <h3><?php echo $c['nama_produk'] ?></h3>
                        </div>
                        <div class="col text-center">
                            <h3>Rp.<?php echo ribuan($c['harga_jual']) ?></h3>
                        </div>
                        <div class="col text-right">
                            <h3>Rp.<?php echo ribuan($subtotalcart3) ?></h3>
                        </div>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="col-12">
                    ...
                    <h3>Diskon <div class="float-right">Rp. <span id="diskon1"></span></div>
                    </h3>
                ...
                <div class="col-12 text-center">
                    ...
                    <p class="h4 text-muted">Powered By.Fahes</p>
                </div>
            </div><!-- end row -->
        </div><!-- end box print -->
        ...
        <table class="table table-striped table-sm table-bordered dt-responsive nowrap print-none" id="cart"
            ...
            <tbody>
                ...
                $subtotalcart1 = 0;
                $no = 1;
                $data_produk = mysqli_query($conn, "SELECT * FROM keranjang c, produk p WHERE p.idproduk=c.idproduk ORDER BY idcart ASC");
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" class="d-inline-block">
                            ...
                            <button type="submit" name="upone" class="btn btn-danger btn-xs"><i
                                    class="fa fa-trash fa-xs mr-1"></i>Hapus</a></button>
                        </form>
                    </td>
                </tr>
                <?php
                    if (isset($_POST['upone'])) {
                        ...
                        if ($stockk < $jml) {
                            ...
                            $query = mysqli_query($conn, "SELECT max(id_stock) as kodeTerbesar FROM stock WHERE idproduk='$idproduk'");
                            $data = mysqli_fetch_array($query);
                            $idstock = $data['kodeTerbesar'];
                            $deletestok = mysqli_query($conn, "DELETE FROM stock WHERE id_stock ='$idstock'");
                            if ($insert1) {
                                //update stok
            ...
            <div class="row">
                <div class="col-lg-6 mb-2">
                    <textarea name="catatan" class="form-control form-control-sm" id="catatan_baru"
                        placeholder="Catatan Transaksi (Jika Ada)" cols="10" rows="5"
                        onchange="new_catatan()"></textarea>
                </div>
                <div class="col-lg-6 mb-2 print-none">
                    <div class="row">
                        <div class="col-5 mb-2 text-right pt-1 pr-2" style="font-weight:500;">Metode :</div>
                        <div class="col-7 mb-2 pl-0">
                            <select type="text" class="form-control form-control-sm bg-white" name="mtd" id='mtd'
                                onchange="Gettotaltabungan()">
                                <option value='1'>Tunai</option>
                                <option value='2'>Tabungan</option>
                            </select>
                        </div>
                        <div class="col-5 mb-2 text-right pt-1 pr-2 dtb" style="display:none;font-weight:500;">Total
                            Tabungan :</div>
                        <div class="col-7 mb-2 pl-0 dtb" style="display:none;">
                            <input type="text" class="form-control form-control-sm bg-white" placeholder="0"
                                name="tabungan" id="tabungan" value=0 readonly>
                        </div>
                        <div class="col-5 mb-2 text-right pt-1 pr-2 dtb" style="display:none;font-weight:500;">Pemakaian
                            Tabungan :</div>
                        <div class="col-7 mb-2 pl-0 dtb" style="display:none;">
                            <input type="number" class="form-control form-control-sm bg-white" placeholder="0"
                                name="ptabungan" id="ptabungan" value=0>
                        </div>
                        <div class="col-5 text-right pt-1 pr-2" style="font-weight:500;">Diskon :</div>
                        <div class="col-7 mb-2 pl-0">
                            <input type="number" class="form-control form-control-sm bg-white" placeholder="0"
                                name="diskon" value="0" id="diskon" onchange="totalnya()">
                        </div>
                        ...
                        <div class="col-7 mb-2 pl-0">
                            ...
                            <input type="hidden" name="idpelanggan" id="idpelanggan" value="" required>
                            <input type="hidden" name="idpelanggann" id="idpelanggann" value="" required>
                            <input type="hidden" name="totalbeli" value="<?php echo $subtotalcart1 ?>" id="hargatotal">
                            <input type="number" class="form-control form-control-sm bg-white" placeholder=""
                        ...
                        <div class="col-5 text-right pt-1 pr-2" style="font-weight:500;"></div>
                        <div class="col-7 pl-0">
                            <input type="checkbox" id="cktab" name="cktab" value="1">
                            <label for="vehicle1">Tabungan</label>
                        </div>
                    </div>
                    <div class="col-12 text-right pr-0 mt-2">
                        <button type="button" class="btn btn-light btn-sm px-3"
                            onclick="document.title='Invoice#<?php echo $kodeCart ?>';window.print()">
...
if (isset($_POST['save'])) {
    ...
    $idpelll    = $_POST['idpelanggann'];
    $pembayaran = $_POST['pembayaran'] + $_POST['ptabungan'];
    $kembalian = $_POST['kembalian'];
    $totalbeli = $_POST['totalbeli'];
    $mtd       = $_POST['mtd'];
    $tabungan  = $_POST['ptabungan'];
    $cektab    = $_POST['cktab'];
    $diskon    = $_POST['diskon'];
    $catatan   = htmlspecialchars($_POST['catatan']);
    if ($idpell != '') {
        $updatetkeranjang = mysqli_query($conn, "UPDATE keranjang SET no_nota='$nonota'") or die(mysqli_connect_error());
        $ambildatacart    = mysqli_query($conn, "INSERT INTO tb_nota (no_nota,idproduk,quantity) SELECT no_nota,idproduk,quantity FROM keranjang") or die(mysqli_connect_error());
        $insertlaporan    = mysqli_query($conn, "INSERT INTO laporan (no_nota,idpelanggan,catatan,pembayaran,kembalian,totalbeli,diskon) VALUES ('$nonota','$idpell','$catatan','$pembayaran','$kembalian','$totalbeli','$diskon')");

        if (isset($_POST['cktab'])) {
            $total_kem   = $kembalian;
            $catatan_kem = 'Kembalian';
            $insert_kem  = mysqli_query($conn, "INSERT INTO tabungan (notransaksi,idpelanggan,total,catatan) VALUES ('$nonota','$idpell','$total_kem','$catatan_kem')");
        }

        if ($mtd == 2) {
            $total_tab   = '-' . $tabungan;
            $catatan_tab = 'Transaksi';
            $insert_tab  = mysqli_query($conn, "INSERT INTO tabungan (notransaksi,idpelanggan,total,catatan) VALUES ('$nonota','$idpell','$total_tab','$catatan_tab')");
        }
        ...
        $updatetkeranjang = mysqli_query($conn, "UPDATE keranjang SET no_nota='$nonota'") or die(mysqli_connect_error());
        $ambildatacart    = mysqli_query($conn, "INSERT INTO tb_nota (no_nota,idproduk,quantity) SELECT no_nota,idproduk,quantity FROM keranjang") or die(mysqli_connect_error());
        $insertlaporan    = mysqli_query($conn, "INSERT INTO laporan (no_nota,idpelanggan,catatan,pembayaran,kembalian,totalbeli,diskon) VALUES ('$nonota','$idpelll','$catatan','$pembayaran','$kembalian','$totalbeli','$diskon')");

        if (isset($_POST['cktab'])) {
            $total_kem   = $kembalian;
            $catatan_kem = 'Kembalian';
            $insert_kem  = mysqli_query($conn, "INSERT INTO tabungan (notransaksi,idpelanggan,total,catatan) VALUES ('$nonota','$idpelll','$total_kem','$catatan_kem')");
        }

        if ($mtd == 2) {
            $total_tab   = '-' . $tabungan;
            $catatan_tab = 'Transaksi';
            $insert_tab  = mysqli_query($conn, "INSERT INTO tabungan (notransaksi,idpelanggan,total,catatan) VALUES ('$nonota','$idpelll','$total_tab','$catatan_tab')");
        }
        $hapusdatacart = mysqli_query($conn, "DELETE FROM keranjang");
...
<?php echo $jsArray, $jsArray1, $jsArray3, $jsArray4, $jsArrayp, $jsArrayp1, $jsArrayp2, $jsArraypp1, $jsArraypp2; ?>
...
function changeValue1(nama_produk) {
    document.getElementById("kode_produk").value = kode_produk[nama_produk].kode_produk;
    document.getElementById("harga_jual").value = harga_jual[nama_produk].harga_jual;
    document.getElementById("idproduk").value = idproduk[nama_produk].idproduk;
    document.getElementById("stock").value = stock[nama_produk].stock;
};
...
function Gettotaltabungan() {
    ...
    var id = document.getElementById('idpelanggan').value;
    if (mtd == 2) {
        $(".dtb").show();
    } else {
        $(".dtb").hide();
...
function totalnya() {
    ...
    var tabungan = parseInt(document.getElementById('ptabungan').value);
    var diskon = parseInt(document.getElementById('diskon').value);
    var kembali = (pembayaran + tabungan) - harga;
    document.getElementById('total1').value = kembali + diskon;
    document.getElementById('total2').innerHTML = kembali + diskon;
    document.getElementById('diskon1').innerHTML = diskon;
    document.getElementById('bayarnya1').innerHTML = pembayaran + tabungan;
}
...
function changeValuePelanggan2(nama_pelanggan) {
    document.getElementById("alamat_pelanggan2").value = alamat_pelanggann[nama_pelanggan].alamat_pelanggann;
    document.getElementById("idpelanggann").value = idpelanggann[nama_pelanggan].idpelanggann;
};
...
function TambahBaru2() {
    var x = document.getElementById("Ada2");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var y = document.getElementById("Tambah2");
    if (y.style.display === "block") {
        y.style.display = "none";
    } else {
        y.style.display = "block";
