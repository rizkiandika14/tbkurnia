...
$result1 = mysqli_query($conn, "SELECT * FROM login where id_login = 3");
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php">
                            <span class="text-center d-block pt-2"><i
                                    class="fa fa-desktop fa-2x"></i></span>Transaksi</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="kategori.php">
                            <span class="text-center d-block pt-2"><i
                                    class="fa fa-box-open fa-2x"></i></span>Kategori</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="laporan.php">
                            <span class="text-center d-block pt-2"><i class="fa fa-chart-bar fa-2x"></i></span>Data
                            laporan
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="tabungan.php">
                            <span class="text-center d-block pt-2"><i class="fa fa-users fa-2x"></i></span>Tabungan</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="logout.php"
                            onclick="javascript:return confirm('Anda yakin ingin keluar ?');">
