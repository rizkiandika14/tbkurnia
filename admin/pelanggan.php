...
<div class="card">
    <div class="card-header">
        <div class="card-tittle"><i class="fa fa-table me-2"></i> Data Pelanggan Member
            <div class="float-right">
                <a href="pelanggan_biasa.php"><button type="button" class="btn btn-info btn-xs p-2">
                        Pelanggan Non Member</button></a>
